...
|---:|---|---|---|
| 1 | BIOCAT-01 trial/FDA state machine ([source contract](BIOCAT_SOURCE_CONTRACT_2026.md); [disclosure-order pilot](BIOCAT_DISCLOSURE_ORDER_PILOT_2026.md)) | trial outcome, milestone hazard, and H13300 announcement purity | version capture works only through a fragile `/api/int` route; exact SEC-name coverage was 30%; the pilot also found program-level label leakage and reaction contamination |
